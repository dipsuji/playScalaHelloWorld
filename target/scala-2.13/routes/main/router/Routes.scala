...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """sujata""", """controllers.HomeController.myIndex"""),
  ...
  // @LINE:8
  private[this] lazy val controllers_HomeController_myIndex1_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("sujata")))
  )
  private[this] lazy val controllers_HomeController_myIndex1_invoker = createInvoker(
    HomeController_1.myIndex,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "myIndex",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:8
    case controllers_HomeController_myIndex1_route(params@_) =>
      call { 
        controllers_HomeController_myIndex1_invoker.call(HomeController_1.myIndex)
      }
